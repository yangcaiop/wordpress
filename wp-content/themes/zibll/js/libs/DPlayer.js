 ...
 * @LastEditTime: 2021-05-26 15:00:45
 */
/*
...
! function (e, t) {
    ...
    return function (e) {
        ...
        function v(e, t) {
            ...
            } else n = c(t), r = y.bind(null, n, t), i = function () {
                ! function (e) {
        ...
        (function (e) {
                    ...
                    function a(e, l) {
                        try {
                            if (l && ("object" === o(l) || "function" == typeof l)) {
                                var s = l.then;
                                if ("function" == typeof s) return void s.call(l, (function (t) {
                                    a(e, t)
                                }), n)
                            }
                            r[e] = l, 0 == --i && t(r)
            ...
            }, c.allSettled = i.a, c.resolve = function (e) {
                return e && "object" === o(e) && e.constructor === c ? e : new c((function (t) {
                    t(e)
                }))
            }, c.reject = function (e) {
                return new c((function (t, n) {
            ...
            return new this((function (t, n) {
                ...
                function a(e, n) {
                    if (n && ("object" === r(n) || "function" == typeof n)) {
                        var l = n.then;
                        if ("function" == typeof l) return void l.call(n, (function (t) {
                            a(e, t)
                        }), (function (n) {
                            i[e] = {
                                status: "rejected",
        ...
        (function (e, t) {
            ! function (e, n) {
                ...
                if (!e.setImmediate) {
                    ...
                    }) : p && "onreadystatechange" in p.createElement("script") ? (i = p.documentElement, r = function (e) {
        ...
        var O = function () {
            function e(t) {
                ...
                }(this, e), this.container = t.container, this.options = t.options, this.tran = t.tran, this.init()
            }
            var t, n, r;
            return t = e, (n = [{
                key: "init",
                value: function () {
                    ...
                    }), this.volumeBar = this.container.querySelector(".dplayer-volume-bar-inner"), this.volumeBarWrap = this.container.querySelector(".dplayer-volume-bar"), this.volumeBarWrapWrap = this.container.querySelector(".dplayer-volume-bar-wrap"), this.volumeButton = this.container.querySelector(".dplayer-volume"), this.volumeButtonIcon = this.container.querySelector(".dplayer-volume-icon"), this.volumeIcon = this.container.querySelector(".dplayer-volume-icon .dplayer-icon-content"), this.playedBar = this.container.querySelector(".dplayer-played"), this.loadedBar = this.container.querySelector(".dplayer-loaded"), this.playedBarWrap = this.container.querySelector(".dplayer-bar-wrap"), this.playedBarTime = this.container.querySelector(".dplayer-bar-time"), this.video = this.container.querySelector(".dplayer-video-current"), this.bezel = this.container.querySelector(".dplayer-bezel-icon"), this.playButton = this.container.querySelector(".dplayer-play-icon"), this.videoWrap = this.container.querySelector(".dplayer-video-wrap"), this.controllerMask = this.container.querySelector(".dplayer-controller-mask"), this.ptime = this.container.querySelector(".dplayer-ptime"), this.loopButton = this.container.querySelector(".dplayer-loop-icon"), this.loopIcon = this.container.querySelector(".dplayer-loop-icon .dplayer-icon-content"), this.dtime = this.container.querySelector(".dplayer-dtime"), this.browserFullButton = this.container.querySelector(".dplayer-full-icon"), this.webFullButton = this.container.querySelector(".dplayer-full-in-icon"), this.notice = this.container.querySelector(".dplayer-notice")
                }
        ...
        var I = function () {
            function e(t) {
                ...
                var r = function () {
                        n.player.resize(), n.isFullScreen("browser") ? n.player.events.trigger("fullscreen") : (c.setScrollPosition(n.lastScrollPosition), n.player.events.trigger("fullscreen_cancel"))
                    },
                    i = function () {
        ...
        var R = function () {
            function e(t) {
                ! function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this.elements = {}, this.elements.volume = t.volumeBar, this.elements.played = t.playedBar, this.elements.loaded = t.loadedBar
            }
            var t, n, r;
            return t = e, (n = [{
                key: "set",
        ...
        var X = function () {
            function e(t) {
                ...
                ! function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this.player = t, this.autoHideTimer = 0, c.isMobile || this.player.container.addEventListener("mousemove", (function () {
                    n.setAutoHide()
                    ...
                    n.setAutoHide()
                })), this.initPlayButton(), this.initPlayedBar(), this.initFullButton(), c.isMobile || this.initVolumeButton()
            }
            var t, n, r;
            return t = e, (n = [{
                key: "initPlayButton",
                value: function () {
                    ...
                    this.player.template.playButton.addEventListener("click", (function () {
                        e.player.toggle()
                    })), c.isMobile ? (this.player.template.videoWrap.addEventListener("click", (function () {
                        e.toggle()
                ...
                value: function () {
                    ...
                    this.player.template.playedBarWrap.addEventListener(c.nameMap.dragStart, (function () {
                        ...
                        e.setAutoHide()
                    })), c.isMobile || (this.player.template.playedBarWrap.addEventListener("mouseenter", (function () {
        ...
        var $ = function e(t) {
            ! function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), document.addEventListener("keydown", (function (e) {
                if (t.focus) {
                    ...
                    switch (r.keyCode) {
                        ...
                        case 39:
                            ...
                            break;
                        case 38:
                            r.preventDefault(), n = t.volume() + .01, t.volume(n, !0);
                            break;
                        case 40:
                            r.preventDefault(), n = t.volume() - .01, t.volume(n, !0)
                    }
        ...
        var Q = [],
            Z = function () {
                function e(t) {
                    ...
                    }, t)), this.tran = new p(this.options.lang).tran, this.events = new A, this.container = this.options.container, this.container.classList.add("dplayer"), this.options.live ? this.container.classList.add("dplayer-live") : this.container.classList.remove("dplayer-live"), c.isMobile && this.container.classList.add("dplayer-mobile"), this.template = new O({
                        container: this.container,
                        options: this.options,
                        tran: this.tran
                    }), this.video = this.template.video, this.bar = new R(this.template), this.bezel = new U(this.template.bezel), this.fullScreen = new I(this), this.controller = new X(this), this.plugins = {}, document.addEventListener("click", (function () {
                        n.focus = !1
                    }), !0), this.container.addEventListener("click", (function () {
                        n.focus = !0
                    }), !0), this.paused = !0, this.timer = new V(this), this.hotkey = new $(this), this.initVideo(this.video, this.options.video.type), this.loop = this.options.loop;
                    ...
                    })), this.loop ? this.events.trigger("loop_enable") : this.events.trigger("loop_disable"), this.options.autoplay && this.play(), this.container.addEventListener("contextmenu", (function (e) {
                ...
                return t = e, (n = [{
                    key: "seek",
                    value: function (e, t) {
                        e = Math.max(e, 0), this.video.duration && (e = Math.min(e, this.video.duration)), this.video.currentTime < e && t ? this.notice("".concat(this.tran("Go forward"), " ").concat((e - this.video.currentTime).toFixed(0), " ").concat(this.tran("seconds"))) : this.video.currentTime > e && t && this.notice("".concat(this.tran("Go back"), " ").concat((this.video.currentTime - e).toFixed(0), " ").concat(this.tran("seconds"))), this.video.currentTime = e, this.bar.set("played", e / this.video.duration, "width"), this.template.ptime.innerHTML = c.secondToTime(e)
                    }
                }, {
                    key: "play",
                    value: function (e) {
                        var t = this;
                        if (this.paused = !1, this.video.paused && this.bezel.switch(q.play), this.template.playButton.innerHTML = q.pause, e || l.a.resolve(this.video.play()).catch((function () {
                                t.pause()
                            })).then((function () {})), this.timer.enable("loading"), this.container.classList.add("dplayer-playing"), this.options.mutex)
                    ...
                    value: function () {
                        this.volume() >= .8 ? this.template.volumeIcon.innerHTML = q.volumeUp : this.volume() > 0 ? this.template.volumeIcon.innerHTML = q.volumeDown : this.template.volumeIcon.innerHTML = q.volumeOff
                    }
                }, {
                    key: "volume",
                    value: function (e, t) {
                        ...
                        if (this.type = t, this.options.video.customType && this.options.video.customType[t]) "[object Function]" === Object.prototype.toString.call(this.options.video.customType[t]) ? this.options.video.customType[t](this.video, this) : console.error("Illegal customType: ".concat(t));
                                ...
                                if (window.Hls)
                                    if (window.Hls.isSupported()) {
                                        var r = this.options.pluginOptions.hls,
                                            i = new window.Hls(r);
                                        this.plugins.hls = i, i.loadSource(e.src), i.attachMedia(e), this.events.on("destroy", (function () {
                            ...
                            case "flv":
                                if (window.flvjs)
                                    if (window.flvjs.isSupported()) {
                                        var o = window.flvjs.createPlayer(Object.assign(this.options.pluginOptions.flv.mediaDataSource || {}, {
                                            type: "flv",
                                            url: e.src
                                        }), this.options.pluginOptions.flv.config);
                                        this.plugins.flvjs = o, o.attachMediaElement(e), o.load(), this.events.on("destroy", (function () {
                            ...
                            case "dash":
                                if (window.dashjs) {
                                    ...
                                    a.updateSettings(l), this.plugins.dash = a, this.events.on("destroy", (function () {
                    ...
                    value: function (e, t) {
                        ...
                        for (var r = function (t) {
                            ...
                            }, i = 0; i < this.events.videoEvents.length; i++) r(i);
                    ...
                    value: function (e) {
                        ...
                        this.template.notice.innerHTML = e, this.template.notice.style.opacity = r, this.noticeTime && clearTimeout(this.noticeTime), this.events.trigger("notice_show", e), n > 0 && (this.noticeTime = setTimeout((function () {
