...
function zibpay_get_withdraw_record_modal($user_id)
{
    ...
    $header = '<div class="mb20 touch"><button class="close" data-dismiss="modal"><svg class="ic-close" aria-hidden="true"><use xlink:href="#icon-close"></use></svg></button><b class="modal-title flex ac"><span class="toggle-radius mr10 b-theme"><i class="fa fa-jpy"></i></span>提现记录</b></div>';
...
function zibpay_withdraw_process($id, $is_allow = true, $msg = '')
{
    ...
    do_action('withdraw_process', $msg_db, $is_allow);
    return true;
}
