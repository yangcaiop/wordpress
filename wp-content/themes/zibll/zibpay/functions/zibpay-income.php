...
function zibpay_get_user_income_post_lists($user_id)
{
    ...
    $posts_query = zibpay_get_user_posts_query($user_id, $paged, $ice_perpage, $orderby);
 ...
 * @return {*}
 */
function zibpay_get_user_posts_query($user_id = 0, $paged = 1, $posts_per_page = 10, $orderby = 'modified')
{
    if (!$user_id) {
