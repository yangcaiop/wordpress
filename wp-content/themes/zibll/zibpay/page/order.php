...
<div class="wrap">
     ...
     <div class="order-header">
          <ul class="subsubsub">
               <li class=""><a class="" href="<?php echo $order_url; ?>">支付订单</a>(<?php echo $all_c ?>)</li> |
               <li class=""><a class="" href="<?php echo $order_url . '&amp;status=0'; ?>">未支付</a>(<?php echo $paid_c ?>)</li> |
          ...
          <table class="widefat fixed striped posts">
               <thead>
                    <tr>
                         ...
                         $theads[] = array('width' => '5%', 'orderby' => 'create_time', 'name' => '时间');
                         $theads[] = array('width' => '3%', 'orderby' => 'pay_num', 'name' => '支付单号');
               ...
               <tbody>
                    ...
                    if ($list) {
                         ...
                         foreach ($list as $value) {
                              ...
                              $post_a .= $value->product_id ? '</br>' . $value->product_id : '';
