...
if (in_array('nav_menu', (array) _pz('message_icon_show', array('nav_menu', 'm_nav_user')))) {
    add_filter('zib_nav_radius_button', function ($but, $user_id) {
...
function zib_get_msg_cat()
{
    ...
    $cat_type['system']  = array('balance', 'points', 'ban_appeal', 'user_report', 'user_report_reply', 'user_ban', 'system', 'promotion', 'vip', 'withdraw_reply', 'withdraw', 'moderator_apply', 'moderator_apply_reply', 'auth_apply_reply', 'auth_apply', 'pay');
