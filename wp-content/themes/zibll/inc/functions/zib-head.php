...
if (_pz('post_keywords_description_s')) {
    ...
    function zib_seo()
    {
        ...
        zib_keywords();
        zib_description();
        echo '<link rel="canonical" href="' . home_url(add_query_arg(null, null)) . '" />';
    }
}
...
function zib_head_css()
{
    ...
    $var .= $opacity1 ? '--focus-color-opacity1:' . $opacity1 . ';' : '';
    ...
    if (_pz('close_backdrop')) {
        $styles .= 'body * {-webkit-backdrop-filter:none !important;backdrop-filter:none !important;}:root{--blur-bg:#ffffff;}body.dark-theme{--blur-bg:#37383a;}';
    }
...
function zib_description($echo = true)
{
    ...
    if (is_singular()) {
        ...
        $description = zib_get_excerpt(210, '...');
