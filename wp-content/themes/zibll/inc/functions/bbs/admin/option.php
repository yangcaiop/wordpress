...
CSF::createSection($prefix, array(
    ...
    'fields'      => array(
        array(
            ...
            <li><a target="_blank" href="https://www.dkewl.com/1164.html">查看官方教程</a></li>
            ',
            'style'   => 'warning',
            'type'    => 'submessage',
        ),
        ...
        array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'step'    => 0.2,
                    'unit'    => '倍',
                    'desc'    => '判断热门板块的标准，同时满足以上要求时则为热门板块<br/>例如：当阅读量大约1000次，且回帖量大于20，且阅读量超过所在分类板块平均阅读量的0.5倍则为热门板块',
                ),
            ),
        ),
        array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'step'    => 0.2,
                    'unit'    => '倍',
                    'desc'    => '判断热门帖子的标准，同时满足以上要求时则为热门帖子<br/>例如：当阅读量大约100次，且回帖量大于5，且阅读量超过所在板块帖子平均阅读量的0.5倍则为热门帖子',
                ),
            ),
        ),
        array(
...
CSF::createSection($prefix, array(
    ...
    'fields'      => array(
        array(
            ...
            <li>默认逻辑如下（请参考）：</li>
            <li>全局功能名叫[论坛]->[论坛]有很多个[板块]->板块可以创建[帖子]内容->[帖子]可以单独设置[专题]和[标签]</li>
        ...
        array(
            ...
            'desc'    => '板块管理员的名称，例如：分区版主，实习分区版主，实习分区管理',
            'default' => '分区版主',
            'class'   => 'compact mini-input',
            'type'    => 'text',
        ),
                                ...
                                array(
                                    ...
                                    'fields'   => array(
                                        ...
                                        array(
                                            ...
                                            'class'      => 'compact',
                                            'title'      => ' ',
                                            'subtitle'   => __('板块排序方式', 'zib_language'),
                                            'default'    => 'views',
                    ...
                    'accordions' => array(
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    'id'          => 'exclude_plate',
                                    'title'       => __('排除板块', 'zib_language'),
                                    'desc'        => '排除所选板块的帖子，支持单选、多选。输入板块关键词搜索选择',
                                    'default'     => array(),
                                    'options'     => 'post',
                                    'query_args'  => array(
                                        'post_type' => 'plate',
                    ...
                    'accordions' => array(
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'fields' => array(
                                        ...
                                        array(
                                            ...
                                            'id'         => 'orderby_include',
                                            'class'      => 'compact',
                                            'subtitle'   => __('显示板块', 'zib_language'),
                                            'desc'       => '请选择并排序需要显示的板块，未选择的分类则不会显示',
                                            'default'    => '',
                                            'options'    => 'post',
                                            'query_args' => array(
                                                'post_type' => 'plate',
                                ...
                                array(
                                    'id'      => 'cat_orderby',
                                    'title'   => __('板块分类排序方式', 'zib_language'),
                                    'default' => 'count',
                                    'options' => array(
                                        'count'      => '板块数量',
                                        'views'      => '热度排序',
                                ...
                                array(
                                    ...
                                    'desc'       => '请选择并排序需要显示的板块类别，未选择的分类则不会显示',
                                    'default'    => '',
                                    'options'    => 'categories',
                                    'chosen'     => true,
                                    'multiple'   => true,
                ...
                array(
                    ...
                    'fields'       => array(
                        array(
                            'title'      => '栏目标题(必填)',
                            'id'         => 'title',
                            'desc'       => '根据下方的不同方式筛选可实现（最新帖子，随机帖子，热门帖子等）以及固定板块帖子的功能',
                            'attributes' => array(
                                'rows' => 1,
                            ),
                            'default'    => '',
                        ...
                        array(
                            'id'          => 'include_plate',
                            'title'       => __('包含板块', 'zib_language'),
                            'desc'        => '仅显示所选板块的帖子，支持单选、多选。输入板块关键词搜索选择',
                            'default'     => '',
                            'options'     => 'post',
                            'query_args'  => array(
                                'post_type' => 'plate',
...
CSF::createSection($prefix, array(
    ...
    'fields'      => array(
        array(
            ...
            'type'    => "checkbox",
            'desc'    => "在页面顶部显示本板信息的卡片，如果关闭PC端显示，可以在侧边栏添加[板块信息]模块",
            'options' => array(
                'pc_s' => 'PC端显示',
                'm_s'  => '移动端显示',
            ),
        ...
        array(
            'title'        => '板块帖子栏目',
            'subtitle'     => '板块页面主要内容',
            'desc'         => '在板块页面显示的栏目内容，请至少保证有两个栏目</br>会自动在第一个栏目内显示置顶文章(置顶文章只会显示为简约模式)</br>每一个tab栏目均独立的地址，地址结尾添加?index=tab序号即可</br>此处栏目为默认配置，也可以为板块单独配置Tab栏目',
            'button_title' => '添加栏目',
            'min'          => 2,
            'id'           => 'bbs_plate_tab',
            'type'         => 'group',
    ...
    array(
        ...
        'fields'      => array(
            ...
            array(
                'dependency' => array('bbs_breadcrumbs_s', '!=', ''),
                'title'      => ' ',
                'subtitle'   => __('显示板块分类', 'zib_language'),
...
CSF::createSection(
    ...
    array(
        ...
        'fields'      => array(
            array(
                'content' => '<div>在此处添加一些[限制发帖]的选项，添加之后可以在板块设置中进行选择，即可实现不同板块不同的发帖限制功能</div>
            ...
            array(
                'content' => '<div>在此处添加一些[限制创建板块]的选项，添加之后可以在板块分类设置中进行选择，即可实现不同板块分类不同的创建板块限制功能</div>
                <div>先设置一个需要的选项数量，刷新页面后再设置每个选项的权限规则以及名称定义</div>
                <div class="c-yellow"><i class="fa fa-fw fa-info-circle fa-fw"></i>修改数量后，请先刷新页面后再做其它配置</div>
                ',
                'title'   => '限制[创建板块]',
...
<p>审核结果将会已站内信以及邮件的方式通知您，请注意查收</p>',
            ...
            array(
                ...
                'clear_title' => '清空图片',
                'default'     => false,
                'desc'        => '标签、板块分类未设置图像时候，显示的默认图像（支持添加多张图像随机显示）',
            ),
            array(
...
class BBS_CFS_Module
{
    ...
    public static function user_caps()
    {
        ...
        $user_all_caps['论坛[板块操作]'] = array(
            array(
                'id'            => 'bbs_' . 'plate_add',
                'name'          => '创建新的板块',
                'desc'          => '请注意：自己创建的板块，自己就是该板块的超级版主！',
                'exclude_roles' => array('all'),
            ),
            array(
                'id'            => 'bbs_' . 'plate_set_add_limit',
                'name'          => '为自己的创建的板块设置发帖权限',
                'exclude_roles' => array('all'),
                'default'       => array(
                    'logged' => true,
                ),
        ...
        $user_all_caps['论坛[板块管理]'] = array(
            array(
                'id'      => 'bbs_' . 'plate_set_add_limit_other',
                'name'    => '为自己管理的板块设置[发帖限制]',
                'roles'   => array('moderator', 'plate_author', 'cat_moderator'),
                'default' => array(
                    'moderator'     => true,
                    'plate_author'  => true,
        ...
        $user_all_caps['论坛[板块分类]'] = array(
            ...
            array(
                ...
                'name'  => '编辑其他人创建的板块分类(危险操作)',
                'roles' => array('cat_moderator'),
            ),
            array(
                'id'    => 'bbs_' . 'plate_cat_delete_other',
                'name'  => '删除其他人创建的板块分类(危险操作)',
                'roles' => array('cat_moderator'),
            ),
        );
        ...
        $user_all_caps['论坛[其它权限]'] = array(
            array(
                ...
                'name'          => '创建[板块分类、话题、标签]的时候允许设置URL别名',
                'exclude_roles' => array('all'),
                'help'          => '依赖于对应的新建权限',
            ),
            array(
                'id'            => 'bbs_' . 'edit_url_slug',
                'name'          => '修改[板块分类、话题、标签]的时候允许修改URL别名',
                'help'          => '依赖于对应的编辑权限',
                'exclude_roles' => array('all'),
            ),
        );
