...
CSF::createSection('plate_extend', array(
    'fields' => array(
        ...
        array(
            ...
            'desc'        => '输入用户名、昵称等关键词以搜索用户<br/>您可以在主题设置中管理' . $zib_bbs->plate_moderator_name . '权限<br/>请勿将管理员、分区版本、板块创建者设置为版主！',
            'chosen'      => true,
            'multiple'    => true,
            'ajax'        => true,
            'settings'    => array(
        ...
        array(
            'id'      => 'add_limit',
            'title'   => '发帖限制',
            'desc'    => '设置一个限制选项，设置后会根据对应选项的限制规则判断是否允许创建板块',
            'default' => 0,
...
CSF::createSection('plate_tab', array(
    'fields' => array(
        ...
        array(
            ...
            'title'        => '板块帖子栏目',
            'subtitle'     => '板块页面主要内容',
            'desc'         => '在板块页面显示的栏目内容，请至少保证有两个栏目</br>会自动在第一个栏目内显示置顶文章(置顶文章只会显示为简约模式)</br>每一个tab栏目均独立的地址，地址结尾添加?index=tab序号即可',
            'button_title' => '添加栏目',
            'min'          => 2,
            'id'           => 'plate_tab',
            'type'         => 'group',
