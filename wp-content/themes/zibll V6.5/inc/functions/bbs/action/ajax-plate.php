...
function zib_bbs_ajax_plate_allow_view_set_modal()
{
    ...
    echo $header;
    echo '<div class="mini-scrollbar scroll-y max-vh5"><div class="em09 muted-2-color mb20">为' . $name . '设置阅读限制，只有满足条件的用户才能查看此板块的' . $zib_bbs->posts_name . '内容</div>' . $allow_view_set . '</div>';
    echo $footer;
    echo '</form>';
    exit;
}
