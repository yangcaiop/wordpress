...
class zib_bbs
{
    ...
    public static function instance()
    {
        ...
        $instance->plate_name           = _pz('bbs_plate_display_name', '板块') ?: '板块';
    ...
    public function add_rewrite_rule()
    {
        ...
        add_rewrite_rule('^' . $this->plate_rewrite_slug . '/([0-9]+)/' . $paged_slug . '/?([0-9]{1,})/?$', 'index.php?post_type=plate&p=$matches[1]&paged=$matches[2]', 'top');
        add_rewrite_rule('^' . $this->posts_rewrite_slug . '/([0-9]+)/' . $paged_slug . '/?([0-9]{1,})/?$', 'index.php?post_type=forum_post&p=$matches[1]&paged=$matches[2]', 'top');
        add_rewrite_rule('^' . $this->posts_rewrite_slug . '/([0-9]+)/' . $comments_slug . '-([0-9]{1,})/?$', 'index.php?post_type=forum_post&p=$matches[1]&cpage=$matches[2]', 'top');

        add_rewrite_rule('^' . $this->plate_rewrite_slug . '/([0-9]+)/?', 'index.php?post_type=plate&p=$matches[1]', 'top');
        add_rewrite_rule('^' . $this->posts_rewrite_slug . '/([0-9]+)/?', 'index.php?post_type=forum_post&p=$matches[1]', 'top');

        //帖子编辑
        add_rewrite_rule('^' . $this->posts_edit_rewrite_slug . '/([0-9]+)/?', 'index.php?forum_post_edit=$matches[1]', 'top');
        add_rewrite_rule('^' . $this->posts_edit_rewrite_slug . '/?', 'index.php?forum_post_edit=add', 'top');
